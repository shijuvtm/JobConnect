...
export default function JobPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD]">
      {/* Header - Moved outside for proper sticky behavior */}
      <header className="bg-white/80 backdrop-blur-md border-b sticky top-0 z-50">
        ...
        {menuOpen && (
          <div className="fixed inset-0 bg-slate-900/20 backdrop-blur-sm z-50 md:hidden">
            <div className="absolute right-0 top-0 h-full w-72 bg-white p-8 shadow-2xl transition-transform duration-300">
